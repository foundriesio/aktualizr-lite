...
Uptane::Target LiteClient::getRollbackTarget(bool ignore_ostree_hash) {
  const auto rollback_hash{ignore_ostree_hash ? "" : sysroot_->getDeploymentHash(OSTree::Sysroot::Deployment::kRollback)};
