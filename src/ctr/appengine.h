...
class AppEngine : public Docker::RestorableAppEngine {
 public:
   ...
   AppEngine(
      ...
      ClientImageSrcFunc client_image_src_func = nullptr,
      bool create_containers_if_install = true, std::string local_source_path = ""):
        Docker::RestorableAppEngine(store_root,
                                    install_root,
                                    docker_root,
                                    registry_client,
                                    docker_client,
                                    ...
                                    compose_cmd,
                                    storage_space_func,
                                    client_image_src_func,
                                    create_containers_if_install,
                                    !local_source_path.empty()),
                                    composectl_cmd_{composectl_cmd}, storage_watermark_{storage_watermark}, local_source_path_{local_source_path} {}
